...
import { getAiApiBase } from "../../utils/runtimeConfig";
  ...
  return (
    <div
      ...
      style={{
        ...
        gap: "8px",
        background:
          "linear-gradient(135deg, rgba(204,17,17,0.15), rgba(136,0,0,0.1))",
...
export default function CertificateVerifyPage({ certificateId, onGoHome }) {
  ...
  const downloadUrl = cert
    ? `${getAiApiBase()}/certificates/${encodeURIComponent(cert.certificate_id)}/download`
    : null;
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(160deg, #0d0d0d 0%, #0a0a0f 50%, #0d0d0d 100%)",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
            ...
            <a
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 8px 28px rgba(204,17,17,0.55)";
              }}
              onMouseLeave={(e) => {
